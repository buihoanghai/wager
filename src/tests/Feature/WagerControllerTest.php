...
class WagerControllerTest extends TestCase
{
     ...
     * @return array
     */
    public static function placeWithValidParamDataProvider():array
    {
        return [
            [
                'params' => [
     ...
     * @return array
     */
    public static function placeWithInvalidParamDataProvider()
    {
        return [
            // total_wager_value
            [
     ...
     * @return array
     */
    public static function listingWithInvalidParamsDataProvider()
    {
        return [
            [
                'params' => [
     ...
     * @return array
     */
    public static function listingWithValidParamsDataProvider()
    {
        return [
            [
                'params' => [
